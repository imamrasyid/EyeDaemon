...
## 2. What EyeDaemon Does

EyeDaemon is a **free, open-source** music companion that lets you:

| Feature            | Description                                                |
| ------------------ | ---------------------------------------------------------- |
| 🎶 **Play**        | Stream from YouTube, SoundCloud, Spotify (via public APIs) |
| 📋 **Queue**       | Add, skip, shuffle, loop, or pause tracks in real-time     |
| ℹ️ **Now-Playing** | Rich embeds with album art, duration, and requester tag    |

> 🔒 **Zero storage** – we never download or host copyrighted audio; everything is fetched on-the-fly from public sources.
